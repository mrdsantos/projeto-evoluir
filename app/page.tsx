  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-base-100 text-neutral-content p-6">
      <div className="text-center max-w-2xl">
        ...
        <Link href="/cadastro">
          <button className="btn btn-primary text-primary-content px-6 py-3 text-lg font-semibold rounded-lg shadow-md hover:shadow-lg transition-all">
            Comece Agora
          </button>
        </Link>
      </div>
      <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-4xl">
        <div className="card bg-base-200 p-6 text-center shadow-lg">
          ...
          <p className="text-neutral-content">Aprenda com projetos reais e conteúdos atualizados.</p>
        </div>
        <div className="card bg-base-200 p-6 text-center shadow-lg">
          <h2 className="text-xl font-semibold text-secondary">Mentoria Especializada</h2>
          <p className="text-neutral-content">Tire suas dúvidas com profissionais experientes.</p>
        </div>
        <div className="card bg-base-200 p-6 text-center shadow-lg">
          <h2 className="text-xl font-semibold text-secondary">Comunidade Ativa</h2>
          <p className="text-neutral-content">Conecte-se com outros alunos e cresça junto.</p>
        </div>
      </div>
    </div>
  );
